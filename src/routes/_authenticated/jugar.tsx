    ...
    <div className="flex flex-col items-center gap-5">
      <div className="flex w-full items-center justify-between">
        ...
        <span className="text-2xl">
          {"🏆".repeat(Math.min(progress.wins, 5)) || "🏆"}
        </span>
      </div>
      ...
      <button onClick={onExit} className="mt-2 text-ink/60 underline">
        Salir
      </button>
    </div>
  );
  ...
  return (
    <div className="flex min-h-[90vh] flex-col justify-between">
      ...
      <div className="mt-4 flex gap-3">
        <BigButton label="Golpe fuerte" color="var(--arcade-orange)" onClick={() => turn("fuerte")} disabled={busy}>
          💥
        </BigButton>
        <BigButton label="Golpe rápido" color="var(--arcade-blue)" onClick={() => turn("rapido")} disabled={busy}>
          ⚡
        </BigButton>
        <BigButton label="Curarse" color="var(--arcade-green)" onClick={() => turn("curar")} disabled={busy}>
          💚
        </BigButton>
      </div>
    </div>
